...
class ActivityLogDbHelper(context: Context) : SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
    ...
    fun addDummyData() {
        ...
        db.execSQL("INSERT INTO $TABLE_ACTIVITY_LOGS ($COLUMN_ACTIVITY, $COLUMN_WEIGHT, $COLUMN_SETS, $COLUMN_REPS, $COLUMN_DATE) VALUES ('Bench Press', 72.5, 3, 10, '2022-03-13')")
        db.execSQL("INSERT INTO $TABLE_ACTIVITY_LOGS ($COLUMN_ACTIVITY, $COLUMN_WEIGHT, $COLUMN_SETS, $COLUMN_REPS, $COLUMN_DATE) VALUES ('Bench Press', 77.5, 3, 10, '2022-03-20')")
        db.execSQL("INSERT INTO $TABLE_ACTIVITY_LOGS ($COLUMN_ACTIVITY, $COLUMN_WEIGHT, $COLUMN_SETS, $COLUMN_REPS, $COLUMN_DATE) VALUES ('Bench Press', 75.0, 3, 10, '2022-03-16')")
        db.execSQL("INSERT INTO $TABLE_ACTIVITY_LOGS ($COLUMN_ACTIVITY, $COLUMN_WEIGHT, $COLUMN_SETS, $COLUMN_REPS, $COLUMN_DATE) VALUES ('Bench Press', 75.0, 3, 10, '2022-03-18')")
        db.execSQL("INSERT INTO $TABLE_ACTIVITY_LOGS ($COLUMN_ACTIVITY, $COLUMN_WEIGHT, $COLUMN_SETS, $COLUMN_REPS, $COLUMN_DATE) VALUES ('Deadlift', 100.0, 3, 10, '2022-03-13')")
